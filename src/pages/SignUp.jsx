      ...
      >
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center">
            ...
            <p
              className={`mt-2 text-subheading ${
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex items-start">
                <div className="flex items-center h-5">
                  <input
                    ...
                    className={`h-4 w-4 ${
                      isEarthy
                        ? "text-rust-500 focus:ring-rust-500 border-tan-300"
                        : "text-slate-blue focus:ring-slate-blue border-cool-grey"
                    } rounded`}
              ...
              <div>
                <button
                  ...
                  } w-full flex justify-center py-2 px-4 disabled:opacity-50`}
                >
                  {isLoading ? (
              ...
              <div className="absolute inset-0 flex items-center">
                <div
                  className={`w-full border-t ${
                    isEarthy ? "border-tan-300" : "border-cool-grey"
                  }`}
                />
              </div>
                ...
                <span
                  className={`px-2 ${
                    isEarthy
                      ...
                      : "bg-pale-lavender text-slate-blue"
                  }`}
                >
                  Or sign up with
                </span>
          ...
          <div
            className={`${
              isEarthy
                ? "bg-tan-50 border-tan-200"
                : "bg-cool-grey/10 border-cool-grey"
          ...
          <div
            className={`text-center p-4 ${
              isEarthy
                ...
                : "bg-blue-grey/10 border-cool-grey"
            } rounded-lg border`}
          >
            <p
              className={`text-sm ${
