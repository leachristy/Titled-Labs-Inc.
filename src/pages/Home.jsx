      ...
      <section className="py-20 bg-rust-400">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          >
            {/* AI Chat Mockup */}
            <div className="visual-frame">
              <div className="space-y-4 visual-card">
                ...
                <div className="mock-chat-message">
                  ...
                  <div className="bg-white mock-chat-bubble border-rust-400">
      ...
      >
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-2">
            {/* Individual Users */}
            <div
              className={`card p-8 transition-colors duration-200 ${
                isEarthy ? "hover:border-rust-400" : "hover:border-slate-blue"
              }`}
      ...
      >
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {/* Resource 1 */}
            <div
              className={`card overflow-hidden transition-colors duration-200 cursor-pointer group ${
                isEarthy ? "hover:border-rust-400" : "hover:border-slate-blue"
              }`}
              style={{ borderColor: isEarthy ? undefined : "var(--cool-grey)" }}
            >
