  ...
  return (
    <>
              ...
              <div className={isEarthy ? "visual-card" : "visual-card-new"}>
                <div
                  className={`mock-portal-header ${
                    isEarthy
                      ? ""
                      : "flex items-center gap-4 pb-4 border-b border-cool-grey"
                  }`}
                >
                  <div
                ...
                <div
                  className={`mock-portal-items ${
                    isEarthy ? "" : "space-y-3 pt-4"
                  }`}
                >
                  <div
                  ...
                  >
                    ...
                    <span
                      className={`font-semibold ${
                        isEarthy ? "text-terracotta-400" : "text-blue-grey"
                      }`}
                    >
                      8 entries
                    </span>
          ...
          >
            ...
            <div className={isEarthy ? "visual-frame" : "visual-frame-new"}>
              ...
              >
                <div
                  className={
                    isEarthy ? "mock-chat-message" : "flex items-start gap-3"
                  }
                >
                  <div
                    className={`mock-chat-avatar ${
                      isEarthy
                        ? "bg-terracotta-400"
                        : "w-10 h-10 rounded-full flex items-center justify-center text-white font-semibold text-sm flex-shrink-0 bg-blue-grey"
                    }`}
                  >
                    AI
                  </div>
                ...
                >
                  <div
                    className={`mock-chat-avatar ${
                      isEarthy
                        ? "bg-rust-500"
                        : "w-10 h-10 rounded-full flex items-center justify-center text-white font-semibold text-sm flex-shrink-0 bg-slate-blue"
                    }`}
                  >
                    ME
                  </div>
                ...
                >
                  <div
                    className={`mock-group-avatar ${
                      isEarthy
                        ? "bg-rust-500"
                        : "w-12 h-12 rounded-lg flex items-center justify-center text-white font-bold flex-shrink-0 bg-slate-blue"
                    }`}
                  >
                    AA
                  </div>
                ...
                >
                  <div
                    className={`mock-group-avatar ${
                      isEarthy
                        ? "bg-terracotta-400"
                        : "w-12 h-12 rounded-lg flex items-center justify-center text-white font-bold flex-shrink-0 bg-blue-grey"
                    }`}
                  >
                    DM
                  </div>
                ...
                >
                  <div
                    className={`mock-group-avatar ${
                      isEarthy
                        ? "bg-tan-300"
                        : "w-12 h-12 rounded-lg flex items-center justify-center text-white font-bold flex-shrink-0 bg-cool-grey"
                    }`}
                  >
                    CR
                  </div>
      ...
      <div
        className={`py-20 ${
          isEarthy
            ? "bg-cream-100 border-t border-tan-200"
            : "bg-pale-lavender border-t border-cool-grey"
        }`}
      >
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
