      ...
      <div className="max-w-4xl px-4 mx-auto text-center sm:px-6 lg:px-8">
        <div className="p-12 border bg-white/10 backdrop-blur-sm rounded-2xl border-white/20">
          <div className="flex items-center justify-center gap-2 mb-6">
            <div className="w-2 h-2 rounded-full bg-cream-100 animate-pulse"></div>
            <span className="text-xs font-semibold tracking-wider text-cream-100">
              NO CREDIT CARD REQUIRED
            </span>
          </div>
          <h2 className="mb-4 text-4xl font-bold text-white">Start for free</h2>
          <p className="max-w-2xl mx-auto mb-8 text-lg text-cream-100">
