export default function CTASection({ onNavigate }) {
  return (
    <section className="py-20 bg-gradient-to-r from-terracotta-400 to-rust-500">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-12 border border-white/20">
          ...
          <p className="text-lg text-cream-100 mb-8 max-w-2xl mx-auto">
            Try Untilted free for 30 days. Experience the complete platform and see how we can support your mental wellness journey.
          </p>
          ...
          <p className="text-sm text-cream-200">
            Join 225,000+ users who trust Untilted for their mental wellness
          </p>
        </div>
      </div>
    </section>
