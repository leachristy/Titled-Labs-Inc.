...
export default function HeroSection({ onNavigate }) {
  return (
    <section className="relative py-20 bg-terracotta-200 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center">
          ...
          {/* Main Heading */}
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-brown-800 mb-6 leading-tight">
          ...
          {/* Subheading */}
          <p className="text-lg sm:text-xl text-brown-700 max-w-3xl mx-auto mb-10 leading-relaxed">
          ...
          {/* Trust Indicators */}
          <div className="flex flex-wrap justify-center items-center gap-6 text-sm text-brown-700">
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 bg-rust-500 rounded-full"></div>
