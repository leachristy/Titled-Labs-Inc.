          ...
          <div className="flex flex-col sm:flex-row gap-6">
            ...
            <div className="flex-1">
              <blockquote className="text-lg text-brown-700 mb-6 leading-relaxed italic">
                "Untilted has completely transformed how I manage my mental health. The AI support is there whenever I need it, and the community groups have connected me with people who truly understand what I'm going through. I've saved so much time and stress—it's been life-changing."
              </blockquote>
              <div>
